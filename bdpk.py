...
ha = current.day
today = date.today()
#shohan2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mshohan')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-shohan/1.2.0 OPN-B'
...
def banner():
    clear()
    print(f"""\033[1;92m
\033[1;91m    _.      S.--. ||H.--. ||O.--. ||H.--. ||A.--. ||N_  ___  ___     __  __  ____  _   __
\033[1;91m   / :/\:   || :/\: || :/\: || :/\: || (\/) || :(): |/  / /   |   / / / / /  _/ / | / /
\033[38;5;208m  /. /:\/: || (__) || :\/: || (__) || :\/: || ()() ||_/ / / /| |  / /_/ /  / /  /  |/ / 
\033[38;5;208m     / '--'S|| '--'H|| '--'O|| '--'H|| '--'A|| '--'N / / / ___ | / __  / _/ /  / /|  /  
\033[1;92m/_/  /  _/ /------'`------'`------'`------'`------'`------'_/  |_|/_/ /_/ /___/ /_/ |_/   
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97MDSHOHAN \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97MDSHOHAN i\033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open )https://www.facebook.com/profile.php?id=100088056494307&mibextid=ZbWKwL
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio shohan_OK.mp3")
                print('\033[1;92m[shohan-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/shohan-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mshohan","\x1b[1;92mshohan","\x1b[1;93mshohan","\x1b[1;94mshohan","\x1b[1;95mshohan","\x1b[1;96mshohan","\x1b[1;97mshohan","\x1b[1;91mshohan","\x1b[1;92mshohan","\x1b[1;93mshohan","\x1b[1;94mshohan","\x1b[1;95mshohan","\x1b[1;96mshohan"])
